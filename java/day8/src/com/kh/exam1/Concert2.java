...
public class Concert2 {
    ...
    public Concert2(String name, int max, int costOverWeb, int costAtVenue) {
    ...
    public void doTicketSale() {
        ...
        if (saleCompleted) {
            ...
            System.out.println("죄송합니다. 잔여 수량이 부족합니다.");
            System.out.println("현재 남아 있는 잔여수량 : " + getTicketsLeft());
        }
    }
